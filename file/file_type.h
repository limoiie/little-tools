enum file_type_e {
	...
	ISO_MEDIA_VIDEO_FOR_ADOBE_FLASH_PLAYER_9_F4V = 162,

	// category: animation
	// description: ISO Media, Protected Video for Adobe Flash Player 9+ (.F4P)
	ISO_MEDIA_PROTECTED_VIDEO_FOR_ADOBE_FLASH_PLAYER_9_F4P = 163,

	// category: animation
	// description: ISO Media, Audio for Adobe Flash Player 9+ (.F4A)
	ISO_MEDIA_AUDIO_FOR_ADOBE_FLASH_PLAYER_9_F4A = 164,

	// category: animation
	// description: ISO Media, Audio Book for Adobe Flash Player 9+ (.F4B)
	ISO_MEDIA_AUDIO_BOOK_FOR_ADOBE_FLASH_PLAYER_9_F4B = 165,
	...
	ISO_MEDIA_OMA_PDCF_DRM_XBS_EXT_OMA_TS_DRM_XBS_V1_0_20070529_C = 207,
	...
	APPLE_HFS_HFS_RESOURCE_FORK = 451,
	...
	OPENDOCUMENT_TEXT = 691,

	// category: archive
	// description: OpenDocument Text Template
	OPENDOCUMENT_TEXT_TEMPLATE = 692,

	// category: archive
	// description: OpenDocument HTML Document Template
	OPENDOCUMENT_HTML_DOCUMENT_TEMPLATE = 693,

	// category: archive
	// description: OpenDocument Master Document
	OPENDOCUMENT_MASTER_DOCUMENT = 694,

	// category: archive
	// description: OpenDocument Drawing
	OPENDOCUMENT_DRAWING = 695,

	// category: archive
	// description: OpenDocument Template
	OPENDOCUMENT_TEMPLATE = 696,

	// category: archive
	// description: OpenDocument Presentation
	OPENDOCUMENT_PRESENTATION = 697,

	// category: archive
	// description: OpenDocument Spreadsheet
	OPENDOCUMENT_SPREADSHEET = 698,

	// category: archive
	// description: OpenDocument Chart
	OPENDOCUMENT_CHART = 699,

	// category: archive
	// description: OpenDocument Formula
	OPENDOCUMENT_FORMULA = 700,

	// category: archive
	// description: OpenDocument Database
	OPENDOCUMENT_DATABASE = 701,

	// category: archive
	// description: OpenDocument Image
	OPENDOCUMENT_IMAGE = 702,
	...
	ZIP_DATA_MIME_TYPE_SS = 704,

	// category: archive
	// description: Java archive data (JAR)
	JAVA_ARCHIVE_DATA_JAR = 705,
	...
	XAR_ARCHIVE_NO_CHECKSUM = 740,

	// category: archive
	// description: xar archive SHA-1 checksum
	XAR_ARCHIVE_SHA_1_CHECKSUM = 741,

	// category: archive
	// description: xar archive MD5 checksum
	XAR_ARCHIVE_MD5_CHECKSUM = 742,

	// category: archive
	// description: Parity Archive Volume Set
	PARITY_ARCHIVE_VOLUME_SET = 743,
	...
	ACRONIS_TRUE_IMAGE_BACKUP = 756,

	// category: archive
	// description: Gentoo binary package (XPAK)
	GENTOO_BINARY_PACKAGE_XPAK = 757,

	// category: assembler
	// description: assembler source text
	ASSEMBLER_SOURCE_TEXT = 758,
	...
	ULT_IMATE_MODULE_SOUND_DATA = 818,

	// category: audio
	// description: ScreamTracker III Module sound data
	SCREAMTRACKER_III_MODULE_SOUND_DATA = 819,
	...
	SYMPHONIE_SYMMOD_MUSIC_FILE = 879,
	...
	XMS_ADLIB_MODULE = 898,

	// category: audio
	// description: XMS Adlib Module Composer: "%s"
	XMS_ADLIB_MODULE_COMPOSER_SS = 899,
	...
	SYNTHESIZER_GENERATOR_OR_KIMWITU_DATA = 917,
	...
	TFMX_MODULE_SOUND_DATA = 919,

	// category: audio
	// description: Monkey's Audio compressed format
	MONKEY_S_AUDIO_COMPRESSED_FORMAT = 920,
	...
	EXTRA_SIMPLE_MUSIC = 928,

	// category: audio
	// description: FM Kingtracker Song
	FM_KINGTRACKER_SONG = 929,
	...
	LOCKSTREAM_EMBEDDED_FILE_MOSTLY_MP3_ON_OLD_NOKIA_PHONES = 938,
	...
	HIVELY_TRACKER_SONG = 972,

	// category: audio
	// description: Hively Tracker Song Hively Tracker Song 1 module data; @reduced@
	HIVELY_TRACKER_SONG_HIVELY_TRACKER_SONG_1_MODULE_DATA_REDUCED = 973,

	// category: audio
	// description: Hively Tracker Song Hively Tracker Song 2 module data; @reduced@
	HIVELY_TRACKER_SONG_HIVELY_TRACKER_SONG_2_MODULE_DATA_REDUCED = 974,
	...
	MODULE_WITH_MP3_VERSION_0_WITH_MP3_AND_LOSSLESS = 976,

	// category: audio
	// description: MOdule with MP3 Version	1	(With ogg and lossless)
	MODULE_WITH_MP3_VERSION_1_WITH_OGG_AND_LOSSLESS = 977,

	// category: audio
	// description: MOdule with MP3 Version 2.2
	MODULE_WITH_MP3_VERSION_2_2 = 978,

	// category: audio
	// description: MOdule with MP3 (With no LAME header)
	MODULE_WITH_MP3_WITH_NO_LAME_HEADER = 979,

	// category: audio
	// description: MOdule with MP3 Version 2.4
	MODULE_WITH_MP3_VERSION_2_4 = 980,
	...
	ART_OF_NOISE_TRACKER_SONG = 982,

	// category: audio
	// description: Farandole Tracker Song
	FARANDOLE_TRACKER_SONG = 983,
	...
	BBX_INDEXED_FILE = 1003,

	// category: basis
	// description: BBx serial file
	BBX_SERIAL_FILE = 1004,
	...
	BIOSIG_PLEXON_V1_0 = 1055,

	// category: biosig
	// description: Biosig/Plexon v2.0
	BIOSIG_PLEXON_V2_0 = 1056,

	// category: biosig
	// description: Biosig/RHD2000: Intan RHD2000 format
	BIOSIG_RHD2000_INTAN_RHD2000_FORMAT = 1057,

	// category: biosig
	// description: Biosig/SCP-ECG format CEN 1064:2005/ISO 11073:91064
	BIOSIG_SCP_ECG_FORMAT_CEN_1064_2005_ISO_11073_91064 = 1058,
	...
	BIOSIG_FILE_EXCHANGE_FORMAT_FEF = 1067,
	...
	B_OUT_ARCHIVE_RANDOM_LIBRARY = 1093,

	// category: bsdi
	// description: 386 compact demand paged pure executable
	A_386_COMPACT_DEMAND_PAGED_PURE_EXECUTABLE = 1094,

	// category: bsdi
	// description: SPARC demand paged
	SPARC_DEMAND_PAGED = 1095,

	// category: bsdi
	// description: SPARC demand paged shared library
	SPARC_DEMAND_PAGED_SHARED_LIBRARY = 1096,

	// category: bsdi
	// description: SPARC demand paged dynamically linked executable
	SPARC_DEMAND_PAGED_DYNAMICALLY_LINKED_EXECUTABLE = 1097,

	// category: bsdi
	// description: SPARC demand paged executable
	SPARC_DEMAND_PAGED_EXECUTABLE = 1098,
	...
	SPARC_PURE_DYNAMICALLY_LINKED_EXECUTABLE = 1100,

	// category: bsdi
	// description: SPARC pure executable
	SPARC_PURE_EXECUTABLE = 1101,
	...
	SPARC_DYNAMICALLY_LINKED_EXECUTABLE = 1103,

	// category: bsdi
	// description: SPARC executable
	SPARC_EXECUTABLE = 1104,

	// category: bsi
	// description: Chiasmus encrypted data
	CHIASMUS_ENCRYPTED_DATA = 1105,
	...
	BTSNOOP_UNENCAPSULATED_HCI = 1108,

	// category: btsnoop
	// description: BTSnoop HCI UART (H4)
	BTSNOOP_HCI_UART_H4 = 1109,

	// category: btsnoop
	// description: BTSnoop HCI BCSP
	BTSNOOP_HCI_BCSP = 1110,

	// category: btsnoop
	// description: BTSnoop HCI Serial (H5)
	BTSNOOP_HCI_SERIAL_H5 = 1111,

	// category: c-lang
	// description: BCPL source text
	BCPL_SOURCE_TEXT = 1112,
	...
	OBJECTIVE_C_SOURCE_TEXT = 1115,

	// category: c-lang
	// description: cscope reference data
	CSCOPE_REFERENCE_DATA = 1116,
	...
	CCS_C64_EMULTAR_CARTRIDGE_IMAGE = 1120,
	...
	C64_RAW_TAPE_FILE_TAP = 1131,

	// category: c64
	// description: GoatTracker 2 song
	GOATTRACKER_2_SONG = 1132,
	...
	BZIP2_COMPRESSED_DATA = 1269,

	// category: compress
	// description: bzip compressed data
	BZIP_COMPRESSED_DATA = 1270,

	// category: compress
	// description: lzip compressed data
	LZIP_COMPRESSED_DATA = 1271,
	...
	SONY_PLAYSTATION_EXECUTABLE = 1347,
	...
	XBE_MICROSOFT_XBOX_EXECUTABLE = 1349,

	// category: console
	// description: XIP, Microsoft Xbox data
	XIP_MICROSOFT_XBOX_DATA = 1350,

	// category: console
	// description: XTF, Microsoft Xbox data
	XTF_MICROSOFT_XBOX_DATA = 1351,

	// category: console
	// description: Lynx homebrew cartridge
	LYNX_HOMEBREW_CARTRIDGE = 1352,
	...
	A_3DO_OPERA_FILE_SYSTEM = 1354,

	// category: console
	// description: Nintendo Gameboy Music/Audio Data
	NINTENDO_GAMEBOY_MUSIC_AUDIO_DATA = 1355,
	...
	NINTENDO_GAMECUBE_WII = 1382,

	// category: console
	// description: Nintendo Wii SDK disc image:
	NINTENDO_WII_SDK_DISC_IMAGE = 1383,

	// category: console
	// description: Nintendo 3DS Game Card image
	NINTENDO_3DS_GAME_CARD_IMAGE = 1384,
	...
	DUMP_FORMAT_4_2_OR_4_3_BSD_IDC_COMPATIBLE = 1402,

	// category: convex
	// description: dump format, Convex Storage Manager by-reference dump
	DUMP_FORMAT_CONVEX_STORAGE_MANAGER_BY_REFERENCE_DUMP = 1403,
	...
	DBASE_IV_WITH_SQL_TABLE_WITH_MEMO_DBT = 1470,

	// category: database
	// description: Clipper SIX with memo
	CLIPPER_SIX_WITH_MEMO = 1471,

	// category: database
	// description: FoxPro with memo
	FOXPRO_WITH_MEMO = 1472,
	...
	MICROSOFT_ACCESS_DATABASE = 1480,

	// category: database
	// description: Extensible storage engine
	EXTENSIBLE_STORAGE_ENGINE = 1481,

	// category: database
	// description: Extensible storage engine DataBase
	EXTENSIBLE_STORAGE_ENGINE_DATABASE = 1482,

	// category: database
	// description: Extensible storage engine STreaMing
	EXTENSIBLE_STORAGE_ENGINE_STREAMING = 1483,

	// category: database
	// description: Windows application compatibility Shim DataBase
	WINDOWS_APPLICATION_COMPATIBILITY_SHIM_DATABASE = 1484,
	...
	DDIS_DOTS_ARCHIVE = 1554,

	// category: digital
	// description: ddis/dtif table data
	DDIS_DTIF_TABLE_DATA = 1555,
	...
	UNIVERSAL_EFI_BINARY_WITH_1_ARCHITECTURE = 1613,

	// category: efi
	// description: Universal EFI binary with 1 architecture, i386
	UNIVERSAL_EFI_BINARY_WITH_1_ARCHITECTURE_I386 = 1614,

	// category: efi
	// description: Universal EFI binary with 1 architecture, x86_64
	UNIVERSAL_EFI_BINARY_WITH_1_ARCHITECTURE_X86_64 = 1615,

	// category: efi
	// description: Universal EFI binary with 2 architectures
	UNIVERSAL_EFI_BINARY_WITH_2_ARCHITECTURES = 1616,

	// category: efi
	// description: Universal EFI binary with 2 architectures, i386
	UNIVERSAL_EFI_BINARY_WITH_2_ARCHITECTURES_I386 = 1617,

	// category: efi
	// description: Universal EFI binary with 2 architectures, x86_64
	UNIVERSAL_EFI_BINARY_WITH_2_ARCHITECTURES_X86_64 = 1618,

	// category: efi
	// description: Universal EFI binary with %d architectures
	UNIVERSAL_EFI_BINARY_WITH_DD_ARCHITECTURES = 1619,
	...
	ENCORE_EXECUTABLE = 1625,

	// category: encore
	// description: Encore pure executable
	ENCORE_PURE_EXECUTABLE = 1626,

	// category: encore
	// description: Encore demand-paged executable
	ENCORE_DEMAND_PAGED_EXECUTABLE = 1627,

	// category: encore
	// description: Encore unsupported executable
	ENCORE_UNSUPPORTED_EXECUTABLE = 1628,
	...
	SYSLINUX_MBR_VERSION_3_35_OR_OLDER = 1720,

	// category: filesystems
	// description: SYSLINUX MBR (version 3.52 or newer)
	SYSLINUX_MBR_VERSION_3_52_OR_NEWER = 1721,

	// category: filesystems
	// description: SYSLINUX MBR (version 3.36-3.51 )
	SYSLINUX_MBR_VERSION_3_36_3_51 = 1722,

	// category: filesystems
	// description: SYSLINUX GPT-MBR
	SYSLINUX_GPT_MBR = 1723,
	...
	NERO_CD_IMAGE_AT_0X4B000 = 1783,

	// category: filesystems
	// description: Compressed ISO CD image
	COMPRESSED_ISO_CD_IMAGE = 1784,

	// category: filesystems
	// description: Linux Compressed ROM File System data, little endian
	LINUX_COMPRESSED_ROM_FILE_SYSTEM_DATA_LITTLE_ENDIAN = 1785,

	// category: filesystems
	// description: Linux Compressed ROM File System data, big endian
	LINUX_COMPRESSED_ROM_FILE_SYSTEM_DATA_BIG_ENDIAN = 1786,
	...
	X11_PORTABLE_COMPILED_FONT_DATA = 1888,

	// category: fonts
	// description: X11 Portable Compiled Font data, bit: LSB,
	X11_PORTABLE_COMPILED_FONT_DATA_BIT_LSB = 1889,

	// category: fonts
	// description: X11 Portable Compiled Font data, bit: MSB,
	X11_PORTABLE_COMPILED_FONT_DATA_BIT_MSB = 1890,

	// category: fonts
	// description: X11 Speedo font data
	X11_SPEEDO_FONT_DATA = 1891,
	...
	QUAKE_II_MAP_FILE_BSP = 1983,

	// category: games
	// description: Quake III Map file (BSP)
	QUAKE_III_MAP_FILE_BSP = 1984,

	// category: games
	// description: Quake II SP2 sprite file
	QUAKE_II_SP2_SPRITE_FILE = 1985,

	// category: games
	// description: Boom or linuxdoom demo
	BOOM_OR_LINUXDOOM_DEMO = 1986,
	...
	GEOSWATCH_AUF_TEXT_FILE = 2144,

	// category: geo
	// description: SeaBeam 2100 multibeam sonar
	SEABEAM_2100_MULTIBEAM_SONAR = 2145,

	// category: geo
	// description: SeaBeam 2100 DR multibeam sonar
	SEABEAM_2100_DR_MULTIBEAM_SONAR = 2146,

	// category: geo
	// description: SeaBeam 2100 PR multibeam sonar
	SEABEAM_2100_PR_MULTIBEAM_SONAR = 2147,
	...
	HP_S200_OLD_ARCHIVE = 2298,

	// category: hp
	// description: HP s500 old archive
	HP_S500_OLD_ARCHIVE = 2299,
	...
	CIS_COMPIMG_HP_BITMAPFILE = 2303,
	...
	HP_NLS_MESSAGE_CATALOG = 2305,

	// category: hp
	// description: HP NLS message catalog, %d messages
	HP_NLS_MESSAGE_CATALOG_DD_MESSAGES = 2306,
	...
	STRUCTURED_FILE = 2346,

	// category: ibm6000
	// description: AIX message catalog
	AIX_MESSAGE_CATALOG = 2347,

	// category: ibm6000
	// description: AIX compiled message catalog
	AIX_COMPILED_MESSAGE_CATALOG = 2348,
	...
	ARCHIVE_BIG_FORMAT = 2350,

	// category: ibm6000
	// description: 64-bit XCOFF executable or object module
	A_64_BIT_XCOFF_EXECUTABLE_OR_OBJECT_MODULE = 2351,

	// category: ibm6000
	// description: 64-bit XCOFF executable or object module not stripped
	A_64_BIT_XCOFF_EXECUTABLE_OR_OBJECT_MODULE_NOT_STRIPPED = 2352,
	...
	PNG_IMAGE_DATA_CGBI = 2425,

	// category: images
	// description: ZIF image (GIF+deflate alpha)
	ZIF_IMAGE_GIF_DEFLATE_ALPHA = 2426,

	// category: images
	// description: FGF image (GIF+deflate beta)
	FGF_IMAGE_GIF_DEFLATE_BETA = 2427,

	// category: images
	// description: PBF image (deflate compression)
	PBF_IMAGE_DEFLATE_COMPRESSION = 2428,
	...
	PAINT_SHOP_PRO_IMAGE_FILE = 2510,

	// category: images
	// description: XV "thumbnail file" (icon) data
	XV_THUMBNAIL_FILE_ICON_DATA = 2511,
	...
	BPG_BETTER_PORTABLE_GRAPHICS = 2574,
	...
	FARBFELD_IMAGE_DATA = 2583,

	// category: images
	// description: Microsoft DirectDraw Surface (DDS):
	MICROSOFT_DIRECTDRAW_SURFACE_DDS = 2584,

	// category: images
	// description: Sega PVR (Xbox) image:
	SEGA_PVR_XBOX_IMAGE = 2585,
	...
	ISO_ZIPPED_FILE = 2641,

	// category: java
	// description: Java serialization data
	JAVA_SERIALIZATION_DATA = 2642,
	...
	BCACHE_CACHE_DEVICE = 2768,

	// category: linux
	// description: BCache backing device
	BCACHE_BACKING_DEVICE = 2769,

	// category: linux
	// description: Device Tree Blob version %d
	DEVICE_TREE_BLOB_VERSION_DD = 2770,
	...
	LUA_BYTECODE_VERSION_5_0 = 2802,

	// category: lua
	// description: Lua bytecode, version 5.1
	LUA_BYTECODE_VERSION_5_1 = 2803,

	// category: lua
	// description: Lua bytecode, version 5.2
	LUA_BYTECODE_VERSION_5_2 = 2804,

	// category: m4
	// description: M4 macro processor script text
	M4_MACRO_PROCESSOR_SCRIPT_TEXT = 2805,
	...
	MACBINARY_III_WITH_SURPRISING_VERSION = 2815,
	...
	BATCHED_NEWS_TEXT = 2840,

	// category: mail.news
	// description: mailed, batched news text
	MAILED_BATCHED_NEWS_TEXT = 2841,

	// category: mail.news
	// description: mail forwarding text
	MAIL_FORWARDING_TEXT = 2842,

	// category: mail.news
	// description: mail piping text
	MAIL_PIPING_TEXT = 2843,
	...
	PE32_EXECUTABLE = 3035,

	// category: msdos
	// description: PE32+ executable
	PE32_EXECUTABLE = 3036,
	...
	PE_UNKNOWN_PE_SIGNATURE = 3038,

	// category: msdos
	// description: FreeDOS KEYBoard Layout collection
	FREEDOS_KEYBOARD_LAYOUT_COLLECTION = 3039,

	// category: msdos
	// description: FreeDOS KEYBoard Layout file
	FREEDOS_KEYBOARD_LAYOUT_FILE = 3040,

	// category: msdos
	// description: MS-DOS KEYBoard Layout file
	MS_DOS_KEYBOARD_LAYOUT_FILE = 3041,
	...
	INSTALLSHIELD_UNINSTALL_SCRIPT = 3100,
	...
	WINDOWS_METAFILE = 3102,

	// category: msdos
	// description: tz3 ms-works file
	TZ3_MS_WORKS_FILE = 3103,
	...
	MS_WINDOWS_SPECIAL_ZIPPED_FILE = 3105,

	// category: msdos
	// description: Icon for MS Windows
	ICON_FOR_MS_WINDOWS = 3106,
	...
	MS_WINDOWS_ICON_RESOURCE = 3108,

	// category: msdos
	// description: MS Windows cursor resource
	MS_WINDOWS_CURSOR_RESOURCE = 3109,
	...
	WINDOWS_SHORTCUT_FILE = 3126,

	// category: msdos
	// description: Windows Program Information File
	WINDOWS_PROGRAM_INFORMATION_FILE = 3127,

	// category: printer
	// description: DOS EPS Binary File
	DOS_EPS_BINARY_FILE = 3128,

	// category: printer
	// description: DOS EPS Binary File Postscript starts at byte %d
	DOS_EPS_BINARY_FILE_POSTSCRIPT_STARTS_AT_BYTE_DD = 3129,
	...
	MICROSOFT_VISUAL_C_LIBRARY = 3179,

	// category: msvc
	// description: Microsoft Visual C .pch
	MICROSOFT_VISUAL_C_PCH = 3180,

	// category: msvc
	// description: MSVC program database
	MSVC_PROGRAM_DATABASE = 3181,

	// category: msvc
	// description: Microsoft Roslyn C# debugging symbols version 1.0
	MICROSOFT_ROSLYN_C_DEBUGGING_SYMBOLS_VERSION_1_0 = 3182,
	...
	MS_WINDOWS_95_INTERNET_SHORTCUT_TEXT = 3375,

	// category: os2
	// description: MS Windows 95 Internet shortcut text (URL=<
	MS_WINDOWS_95_INTERNET_SHORTCUT_TEXT_URL = 3376,
	...
	OS9_68K_MODULE_RE_ENTRANT = 3405,

	// category: os9
	// description: OS9/68K module: ghost
	OS9_68K_MODULE_GHOST = 3406,

	// category: os9
	// description: OS9/68K module: system-state
	OS9_68K_MODULE_SYSTEM_STATE = 3407,

	// category: osf1
	// description: OSF/Rose object
	OSF_ROSE_OBJECT = 3408,

	// category: osf1
	// description: i386 COFF object
	I386_COFF_OBJECT = 3409,
	...
	MAKI_CHAN_V2_IMAGE = 3445,

	// category: pc98
	// description: Maki-chan v2 image, system ID: %c
	MAKI_CHAN_V2_IMAGE_SYSTEM_ID_CC = 3446,

	// category: pc98
	// description: XLD4(Q4) picture
	XLD4_Q4_PICTURE = 3447,

	// category: pc98
	// description: Yanagisawa Pi 16 color picture,
	YANAGISAWA_PI_16_COLOR_PICTURE = 3448,
	...
	MERCURIAL_BUNDLE = 3625,

	// category: revision
	// description: Mercurial bundle, uncompressed
	MERCURIAL_BUNDLE_UNCOMPRESSED = 3626,

	// category: revision
	// description: Mercurial bundle, bzip2 compressed
	MERCURIAL_BUNDLE_BZIP2_COMPRESSED = 3627,

	// category: revision
	// description: Subversion dumpfile
	SUBVERSION_DUMPFILE = 3628,
	...
	RPM_BIN_I386_X86_64 = 3678,

	// category: rpm
	// description: RPM bin Alpha/Sparc64
	RPM_BIN_ALPHA_SPARC64 = 3679,
	...
	DISK_QUOTAS_FILE = 3750,

	// category: sgi
	// description: IRIS Showcase file
	IRIS_SHOWCASE_FILE = 3751,

	// category: sgi
	// description: IRIS Showcase template
	IRIS_SHOWCASE_TEMPLATE = 3752,

	// category: sgi
	// description: IRIX Parallel Arena
	IRIX_PARALLEL_ARENA = 3753,
	...
	IRIX_64_BIT_CORE_DUMP = 3755,

	// category: sgi
	// description: IRIX N32 core dump
	IRIX_N32_CORE_DUMP = 3756,

	// category: sgi
	// description: IRIX vmcore dump of
	IRIX_VMCORE_DUMP_OF = 3757,
	...
	GLF_BINARY_LSB_FIRST = 3765,

	// category: sgi
	// description: GLF_BINARY_MSB_FIRST
	GLF_BINARY_MSB_FIRST = 3766,
	...
	GLS_BINARY_LSB_FIRST = 3768,

	// category: sgi
	// description: GLS_BINARY_MSB_FIRST
	GLS_BINARY_MSB_FIRST = 3769,

	// category: sgi
	// description: PCP compiled namespace (V.0)
	PCP_COMPILED_NAMESPACE_V_0 = 3770,

	// category: sgi
	// description: PCP compiled namespace
	PCP_COMPILED_NAMESPACE = 3771,
	...
	PCP_ARCHIVE_TEMPORAL_INDEX = 3773,

	// category: sgi
	// description: PCP archive metadata
	PCP_ARCHIVE_METADATA = 3774,

	// category: sgi
	// description: PCP archive log volume #0
	PCP_ARCHIVE_LOG_VOLUME_0 = 3775,

	// category: sgi
	// description: PCP archive log volume #%d
	PCP_ARCHIVE_LOG_VOLUME_DD = 3776,
	...
	ALIAS_MAYA_ASCII_FILE = 3792,

	// category: sgi
	// description: Alias Maya Binary File,
	ALIAS_MAYA_BINARY_FILE = 3793,

	// category: sgi
	// description: Alias Maya Image File
	ALIAS_MAYA_IMAGE_FILE = 3794,

	// category: sgml
	// description: SVG Scalable Vector Graphics image
	SVG_SCALABLE_VECTOR_GRAPHICS_IMAGE = 3795,
	...
	SOUNDTRAKKER_128_ST2_MUSIC = 4012,
	...
	SYSEX_FILE_VOYCE = 4024,

	// category: sysex
	// description: SysEx File - Waveframe
	SYSEX_FILE_WAVEFRAME = 4025,
	...
	TIMEZONE_DATA_OLD_VERSION = 4289,

	// category: timezone
	// description: old timezone data
	OLD_TIMEZONE_DATA = 4290,
	...
	UUENCODED_OR_XXENCODED_TEXT = 4317,
	...
	INTEL_QUARK_EXPRESS_DOCUMENT_ENGLISH = 4615,

	// category: wordprocessors
	// description: Intel Quark Express Document (Korean)
	INTEL_QUARK_EXPRESS_DOCUMENT_KOREAN = 4616,

	// category: wordprocessors
	// description: Motorola Quark Express Document (English)
	MOTOROLA_QUARK_EXPRESS_DOCUMENT_ENGLISH = 4617,

	// category: wordprocessors
	// description: Motorola Quark Express Document (Korean)
	MOTOROLA_QUARK_EXPRESS_DOCUMENT_KOREAN = 4618,
	...
	MICROSOFT_A_OUT = 4645,

	// category: xenix
	// description: old Microsoft 8086 x.out
	OLD_MICROSOFT_8086_X_OUT = 4646,
	...
	XENIX_8086_RELOCATABLE_OR_80286_SMALL_MODEL = 4648,

	// category: xilinx
	// description: Xilinx BIT data
	XILINX_BIT_DATA = 4649,

	// category: xilinx
	// description: Xilinx RAW bitstream (.BIN)
	XILINX_RAW_BITSTREAM_BIN = 4650,
	...
	XO65_OBJECT_WITH_DEBUG_INFO = 4652,

	// category: xo65
	// description: xo65 object, no debug info
	XO65_OBJECT_NO_DEBUG_INFO = 4653,
	...
	COMPILED_XKB_KEYMAP_LSB = 4658,

	// category: xwindows
	// description: Compiled XKB Keymap: lsb, obsolete
	COMPILED_XKB_KEYMAP_LSB_OBSOLETE = 4659,

	// category: xwindows
	// description: Compiled XKB Keymap: msb,
	COMPILED_XKB_KEYMAP_MSB = 4660,

	// category: xwindows
	// description: Compiled XKB Keymap: msb, obsolete
	COMPILED_XKB_KEYMAP_MSB_OBSOLETE = 4661,

	// category: xwindows
	// description: xfsdump archive
	XFSDUMP_ARCHIVE = 4662,
	...
	JALEO_XFS_FILE_DD = 4664,

	// category: xwindows
	// description: Jaleo XFS fileYUV422]
	JALEO_XFS_FILEYUV422 = 4665,

	// category: xwindows
	// description: Jaleo XFS fileRGB24]
	JALEO_XFS_FILERGB24 = 4666,
